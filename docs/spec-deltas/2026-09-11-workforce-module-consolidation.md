...
- Top-level navigation displays one workforce entry; the separate Schedule navigation entry is hidden.
- The legacy `#schedule` route remains functional as the Schedule tab so old links and existing app handlers do not break.
