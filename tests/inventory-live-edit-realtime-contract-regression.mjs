...
assert.match(cloud,/if \(\(force \|\| masterChanged\) && !changed\)[\s\S]{0,220}shitu:inventory-cloud-updated/,"forced remote reconciliation must repaint a peer tab even when shared localStorage already contains the new snapshot");
