...
assert(index.includes("src/action-feedback.js?v=__KITCHEN_RELEASE__"), "confirmed-result feedback runtime must be release-stamped and loaded");
assert(!index.includes("src/all-button-feedback.js"), "pure UI controls must not generate generic success notifications");
assert(
