...
const tempPath = path.join(__dirname, ".business-module-conflict-regression-v16.tmp.mjs");
...
const migrated = source.replace(
  legacyAssertion,
  'assert.equal(health.data.schema, "016", "Database Core v2 migrations are not active");'
);
