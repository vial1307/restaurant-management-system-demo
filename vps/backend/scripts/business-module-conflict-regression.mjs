...
const tempPath = path.join(__dirname, ".business-module-conflict-regression-v18.tmp.mjs");
...
const migrated = source.replace(
  legacyAssertion,
  'assert.equal(health.data.schema, "018", "Database Core v2 migrations are not active");'
);
