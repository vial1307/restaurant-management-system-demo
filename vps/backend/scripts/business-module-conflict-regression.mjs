...
const tempPath = path.join(__dirname, ".business-module-conflict-regression-v19.tmp.mjs");
...
const migrated = source.replace(
  legacyAssertion,
  'assert.equal(health.data.schema, "019", "Database Core v2 migrations are not active");'
);
