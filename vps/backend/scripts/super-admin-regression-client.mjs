...
try {
  ...
  assert.equal(development.data.release_evidence.workflow_run_id, "35525341848");
  assert.equal(development.data.release_evidence.inventory_audit_run_id, "35525613008");
