...
try {
  ...
  assert.equal(overview.data.schema.version, "023");
  ...
  assert.equal(development.data.current_work.candidate_schema, "023");
  assert.equal(development.data.runtime.schema.version, "023");
  assert.equal(development.data.live_production.schema, "023");
